<x-master>
<div class="container mx-auto bg-gray-400 px-6 py-4 rounded-lg border">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="font-bold text-2xl mb-4">{{ __('Login') }}</div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mt-3">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="px-6 py-2 font-bold rounded-lg bg-blue-500 text-white">
                                    {{ __('Login') }}
                                </button>

                                @if (Route::has('password.request'))
                                    <a class="px-6 py-2 text-blue-800 font-bold" href="{{ route('password.request') }}">
